...
const repository = require('../../robots/robots/src/repository/sp/worten.repository');
repository.findOne = () => false;
repository.save = () => false;
repository.update = () => false;
const { getInfo, oneClick } = require('../../robots/robots/src/domain/sp/worten.domain');
const reqID = "testing_desig";

const merchant = 'WORTEN';

const credentials = {
  login: 'jrodrigo00@hotmail.es', password: '01022015'
};
